...
public class FeedController {
    ...
    public String rss() {
        ...
        xml.append("    <atom:link href=\"http://localhost:8080/feed.xml\" rel=\"self\" type=\"application/rss+xml\"/>\n");

        for (Post post : page.getRecords()) {
            xml.append("    <item>\n");
            xml.append("      <title>").append(escapeXml(post.getTitle())).append("</title>\n");
            xml.append("      <link>http://localhost:8080/blog/").append(post.getSlug()).append("</link>\n");
            xml.append("      <guid>http://localhost:8080/blog/").append(post.getSlug()).append("</guid>\n");
            xml.append("      <description>").append(escapeXml(post.getDescription())).append("</description>\n");
            if (post.getCreatedAt() != null) {
                xml.append("      <pubDate>").append(post.getCreatedAt().format(DateTimeFormatter.RFC_1123_DATE_TIME)).append("</pubDate>\n");
            }
            xml.append("    </item>\n");
        }
