...
export const useAuthStore = defineStore('auth', () => {
  ...
  async function login(user, password) {
    ...
    saveUser(res.token, res.username, res.nickname, res.role, res.userId)
    return res
  }
  ...
  return { token, username, nickname, role, userId, isLoggedIn, isAdmin, login, register, logout, saveUser }
})
